                ...
                React.createElement("div", {id: "sidebarMenu", className: "sidebar-menu"}, 
                    React.createElement("ul", null, 
                        React.createElement("li", null, 
                            React.createElement("a", {id: "sideMenuBigDAccountInfo", href: SiteProperties.webURL + Page.bigdAccountInfo}, 
                                React.createElement("i", {className: "fa fa-user"}), 
                                React.createElement("span", null, "账户信息")
                            )
                        ), 
                        React.createElement("li", null, 
                            React.createElement("a", {id: "sideMenuBigDOrder", href: "javascript:void(0)", className: "has-sub", onClick: this.handleToggleSub}, 
                            ...
                            React.createElement("ul", null, 
                                React.createElement("li", null, 
                                    React.createElement("a", {id: "sideMenuBigDOrderSearch", href: SiteProperties.webURL + Page.bigdOrderList}, "资信查询")
                                ), 
                                React.createElement("li", null, 
